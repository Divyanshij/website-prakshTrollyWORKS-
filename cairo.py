...
CAIRO_STATUS_DWRITE_ERROR = _cairo.CAIRO_STATUS_DWRITE_ERROR
CAIRO_STATUS_SVG_FONT_ERROR = _cairo.CAIRO_STATUS_SVG_FONT_ERROR
...
CAIRO_DITHER_NONE = _cairo.CAIRO_DITHER_NONE
CAIRO_DITHER_DEFAULT = _cairo.CAIRO_DITHER_DEFAULT
CAIRO_DITHER_FAST = _cairo.CAIRO_DITHER_FAST
CAIRO_DITHER_GOOD = _cairo.CAIRO_DITHER_GOOD
CAIRO_DITHER_BEST = _cairo.CAIRO_DITHER_BEST

def cairo_pattern_set_dither(pattern, dither):
    return _cairo.cairo_pattern_set_dither(pattern, dither)

def cairo_pattern_get_dither(pattern):
    return _cairo.cairo_pattern_get_dither(pattern)
...
def cairo_set_hairline(cr, set_hairline):
    return _cairo.cairo_set_hairline(cr, set_hairline)
...
CAIRO_TAG_CONTENT = _cairo.CAIRO_TAG_CONTENT
CAIRO_TAG_CONTENT_REF = _cairo.CAIRO_TAG_CONTENT_REF
...
CAIRO_COLOR_MODE_DEFAULT = _cairo.CAIRO_COLOR_MODE_DEFAULT
CAIRO_COLOR_MODE_NO_COLOR = _cairo.CAIRO_COLOR_MODE_NO_COLOR
CAIRO_COLOR_MODE_COLOR = _cairo.CAIRO_COLOR_MODE_COLOR
...
CAIRO_COLOR_PALETTE_DEFAULT = _cairo.CAIRO_COLOR_PALETTE_DEFAULT

def cairo_font_options_set_color_mode(options, color_mode):
    return _cairo.cairo_font_options_set_color_mode(options, color_mode)

def cairo_font_options_get_color_mode(options):
    return _cairo.cairo_font_options_get_color_mode(options)

def cairo_font_options_get_color_palette(options):
    return _cairo.cairo_font_options_get_color_palette(options)

def cairo_font_options_set_color_palette(options, palette_index):
    return _cairo.cairo_font_options_set_color_palette(options, palette_index)

def cairo_font_options_set_custom_palette_color(options, index, red, green, blue, alpha):
    return _cairo.cairo_font_options_set_custom_palette_color(options, index, red, green, blue, alpha)

def cairo_font_options_get_custom_palette_color(options, index, red, green, blue, alpha):
    return _cairo.cairo_font_options_get_custom_palette_color(options, index, red, green, blue, alpha)
...
CAIRO_FONT_TYPE_DWRITE = _cairo.CAIRO_FONT_TYPE_DWRITE
...
def cairo_user_font_face_set_render_color_glyph_func(font_face, render_glyph_func):
    return _cairo.cairo_user_font_face_set_render_color_glyph_func(font_face, render_glyph_func)

def cairo_user_font_face_get_render_color_glyph_func(font_face):
    return _cairo.cairo_user_font_face_get_render_color_glyph_func(font_face)

def cairo_user_scaled_font_get_foreground_marker(scaled_font):
    return _cairo.cairo_user_scaled_font_get_foreground_marker(scaled_font)

def cairo_user_scaled_font_get_foreground_source(scaled_font):
    return _cairo.cairo_user_scaled_font_get_foreground_source(scaled_font)
...
def cairo_get_hairline(cr):
    return _cairo.cairo_get_hairline(cr)
...
def cairo_surface_observer_print(abstract_surface, write_func, closure):
    return _cairo.cairo_surface_observer_print(abstract_surface, write_func, closure)

def cairo_surface_observer_elapsed(abstract_surface):
    return _cairo.cairo_surface_observer_elapsed(abstract_surface)

def cairo_device_observer_print(abstract_device, write_func, closure):
    return _cairo.cairo_device_observer_print(abstract_device, write_func, closure)

def cairo_device_observer_elapsed(abstract_device):
    return _cairo.cairo_device_observer_elapsed(abstract_device)

def cairo_device_observer_paint_elapsed(abstract_device):
    return _cairo.cairo_device_observer_paint_elapsed(abstract_device)

def cairo_device_observer_mask_elapsed(abstract_device):
    return _cairo.cairo_device_observer_mask_elapsed(abstract_device)

def cairo_device_observer_fill_elapsed(abstract_device):
    return _cairo.cairo_device_observer_fill_elapsed(abstract_device)

def cairo_device_observer_stroke_elapsed(abstract_device):
    return _cairo.cairo_device_observer_stroke_elapsed(abstract_device)

def cairo_device_observer_glyphs_elapsed(abstract_device):
    return _cairo.cairo_device_observer_glyphs_elapsed(abstract_device)
